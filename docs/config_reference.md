...
- ??/??/??/???int????`configs/default.yaml` ?? 30000?demo ? 20000??????
- ?????/??????? standard ????????????????`src/pipeline/standard.py::_process_standard_source`?
- ????????????? 10000?20000?
- ?????????????????????????

#### preprocess.geomag
- ??/??/??/???object??????? `configs/default.yaml`?
- ?????/???????????????`src/pipeline/standard.py::_apply_geomag_aef_preprocess`?`_clean_timeseries_group`?
- ??????/??????
  - `detrend.method`?string??? `linear`?
  - `highpass.window_points`?int??? 600?
  - `highpass.method`?string??? `rolling_median`?
  - `wavelet.name`?string??? `db4`?
  - `wavelet.level`?int|null??? null=???
  - `wavelet.threshold_scale`?float??? 1.0?
  - `wavelet.mode`?string??? `soft`?
- ??????/??/????
  - `outlier.threshold`?float??? 6.0?MAD?
  - `interpolate.max_gap_points`?int??? 10?
  - `interpolate.method`?string??? `linear`?
  - `lowpass.window_points`?int??? 5?
- ?????`max_gap_points` ??????????????????????

#### preprocess.aef
- ??/??/??/???object??????? `configs/default.yaml`?
- ?????/???????????????`src/pipeline/standard.py::_apply_geomag_aef_preprocess`?`_clean_timeseries_group`?`_process_standard_source`?
- ??????/??????
  - `detrend.method`?string??? `linear`?
  - `highpass.window_points`?int??? 300?
  - `highpass.method`?string??? `rolling_median`?
  - `wavelet.name`?string??? `db4`?
  - `wavelet.level`?int|null??? null=???
  - `wavelet.threshold_scale`?float??? 1.0?
  - `wavelet.mode`?string??? `soft`?
- ??????/??/??/??????
  - `despike.window_points`?int??? 5?
  - `despike.zscore_mad_threshold`?float??? 6.0?
  - `outlier.threshold`?float??? 6.0?MAD?
  - `interpolate.max_gap_points`?int??? 5?
  - `interpolate.method`?string??? `linear`?
  - `lowpass.window_points`?int??? 5?
  - `expand_minute_to_seconds.seconds`?int??? 60?
  - `expand_minute_to_seconds.mode`?string??? `centered`?
  - `expand_minute_to_seconds.chunk_rows`?int??? 2000?
- ??????????????????????????????

#### preprocess.seismic_bandpass
- ??/??/??/???object??????? `configs/default.yaml`?
- ?????/???????????/??/???????`src/pipeline/standard.py::_apply_seismic_preprocess`?
- ????
  - `freqmin_hz`?float??? 0.5?
  - `freqmax_user_hz`?float??? 20.0?
  - `freqmax_nyquist_ratio`?float??? 0.45??????????
  - `taper_max_percentage`?float??? 0.05?
  - `corners`?int??? 4?
  - `zerophase`?bool??? true?
  - `notch.base_hz`?number[]??? [50,60]?
  - `notch.half_width_hz`?float??? 0.5?
  - `notch.harmonics`?int??? 0=???
- ?????`freqmax` ?? Nyquist ??????????????

#### preprocess.vlf_preprocess
- ??/??/??/???object??????? `configs/default.yaml`?
- ?????/?????VLF ???????????`src/pipeline/standard.py::_vlf_features`?
- ??????/??????
  - `freq_line_mask.base_hz`?number[]??? [50,60]?
  - `freq_line_mask.harmonics`?int??? 5?
  - `freq_line_mask.half_width_hz`?float??? 0.5?
  - `time_median_window`?int??? 3?
- ?????????/?????
  - `standardize.bands_hz`?number[]??? [10,1000,3000,10000]?
  - `standardize.freq_agg`?string??? `median`?
  - `standardize.time_agg`?string??? `median`?
  - `standardize.target_interval`?string??? `1min`?
  - `background_subtract.method`?string??? `median`?
- ?????VLF ???? join ????????????????????????
...
- ??/??/??/???int?????? `50`?demo ? `20`??????
- ?????/????????? TopN ???`src/pipeline/model.py::run_model`?
- ???????????? 10 ?????? `10`?
- ????????????????

#### features.anomaly_threshold
- ??/??/??/???float?????? `3.0`????????YAML ???????
- ?????/??????? z-score ???`src/pipeline/model.py::run_model`?
- ???????????????? `2.5` ?? YAML ???????
- ?????????????????????????????

#### features.association
- ??/??/??/???object??????? YAML?
- ?????/??????????????`src/pipeline/model.py::_compute_association`?

#### features.association.change_threshold
- ??/??/??/???float?????? `3.0`?
- ?????/?????pre/post ???????`src/pipeline/model.py::_compute_association`?

#### features.association.min_sources
- ??/??/??/???int?????? `2`?
- ?????/?????????????????

#### features.association.corr_threshold
- ??/??/??/???float?????? `0.6`?
- ?????/???????????????

#### features.association.max_lag_minutes
- ??/??/??/???int?????? `30`?
- ?????/?????????????????

#### features.association.lag_step_minutes
- ??/??/??/???int?????? `1`?
- ?????/?????????????????

#### features.association.min_overlap
- ??/??/??/???int?????? `30`?
- ?????/???????????????????

#### features.association.min_points
- ??/??/??/???int?????? `20`?
- ?????/??????? z-score/????????????

#### features.association.topn_pairs
- ??/??/??/???int?????? `50`?
- ?????/?????????????? N ??
